            ...
            <div class="col-md-8 bg-light">
                <div class="card-body">
                    ...
                    <div class="form-check">
                        ...
                        <input class=" col-4" id="confermaNuovaPassword" type="password" name="nuovaPassword_confirmation"/>
                    </div>
                </div>
            </div>
        </div>
        <div class="card-footer">
            <label for="passwordAttuale" class="card-text">Inserisci la tua password attuale per permettere la modifica dei tuoi dati:</label>
