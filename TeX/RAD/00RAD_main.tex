...
\begin{center}
	...
	\hline
	20/01/2021 & 1.2 & Aumentata la consistenza in scenari e casi d'uso, convertito completamente il documento in formato TeX \\
	\hline
   \end{tabular}
\end{center}
...
\input{01RAD_introduzione.tex}
 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Sistema Corrente}
\input{02RAD_SistemaCorrente.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Sistema Proposto}
\input{03RAD_SistemaProposto.tex}
